...
background_image = pygame.image.load("Images-Game/eric.png")
...
joueur_image = pygame.image.load("Images-Game/val.png")
...
objet_image = pygame.image.load("Images-Game/marius.png")
